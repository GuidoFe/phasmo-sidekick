...
var DataManager = require('@modules/DataManager');
var path = require('path');
var challengesFolder = path.dirname(require.resolve('@index')) + '/challenges';
var commandsFolder = path.dirname(require.resolve('@index')) + '/commands';
var CommandManager = require('@modules/CommandManager');
var utils = require('@utils');
var dataManager = new DataManager();
dataManager.init(constants, challengesFolder);
var commandManager = new CommandManager(commandsFolder, dataManager);
...
client.once('ready', function () {
    ...
    setInterval(function () {
        var activity = utils.pickRandom(statusMessages);
